...
- Want to model a daily ride count using weather, income, and other socio-economic predictors
	- Poisson model
...
- Assumes:
	- data follows Poisson distrubion
	- mean = variance
...
- Dispersion statistic = 'r code here'
...
- Dispersion drops to 'r #code here' → much better fit

## Negative Binomial
### Model

explain the negative binomial model, the full, then the sinplified
