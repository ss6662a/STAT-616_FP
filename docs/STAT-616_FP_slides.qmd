...
- Want to predict how the number of rides will differ as income differs and weather changes
  - interaction between income and weather
- Count data so Poisson model

- interaction term, count data
