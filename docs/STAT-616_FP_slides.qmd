...
- Poisson model dispersion statistic = `r round(poi_overdispersion, 2)`
	- Variance is nearly 12× the mean
...
explain the negative binomial model, the full, then the simplified
...
- The interaction has a small, but significant impact on the count of rides.
- other conclusions
